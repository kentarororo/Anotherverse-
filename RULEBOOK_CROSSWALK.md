...
| 6–10, 20, 33–36 | Identity, role, ideal, bond, and flaw reinforce play               | Adapt    | Mythic hero blueprints                       | Path, desire, fatal flaw, exact techniques in one dossier | Generated trio schema test              |
...
The first three turns now use the seeded mythic opening as canonical scenarios. Turn 1 proves the complete loop: a mythic danger, exact position/stance/priority rules, deterministic autobattle, a three-beat causal recap, rewards, and a written campaign fact. Later corpus replacement remains gated on preserving this causal contract.
