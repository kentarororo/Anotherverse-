...
| Choose one Tank, Damage, or Support lead; recruit the other two in authored Chapters 1 and 2                                    | `forge-roster.test.ts`; `opening-recruitment.test.ts`; `playwrite-slice.spec.ts`                | Pass                     |
